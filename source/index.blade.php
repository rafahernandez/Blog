...
@section('body')
  <section class="flex-col justify-center items-center text-center mb-20">
    ...
    <ul class="list-none">
      <li>👨💼 &nbsp; Senior backend developer at <a href="https://karbook.com" rel="nofollow noreferrer">Karbook</a></li>
    ...
    <div class="flex items-center justify-around max-w-xs mx-auto pt-6 mb-8">
      <div class="px-1 mx-4"><a href="https://twitter.com/joraheta" target="_blank" rel="noopener">
          <svg width="26" height="22" viewBox="0 0 26 22" xmlns="http://www.w3.org/2000/svg"
               class="fill-current w-4 hover:text-blue-darkest">
            <path
                ...
                fill-rule="evenodd" class="social-icon"></path>
          </svg>
        </a></div>
      <div class="px-1 mx-4"><a href="https://www.youtube.com/" target="_blank"
                                rel="noopener">
      ...
      <div class="px-1 mx-4"><a href="https://www.linkedin.com/in/jose-rafael-hernandez-tadeo/" target="_blank"
                                rel="noopener">
